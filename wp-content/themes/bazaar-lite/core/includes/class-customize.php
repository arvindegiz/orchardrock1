		...
		public function render_content() { ?>
            ...
            <div class="inside">
                ...
                <ul>
                    ...
                    <li><a class="button purchase-button" href="<?php echo esc_url( 'https://www.themeinprogress.com/bazaar-free-ecommerce-wordpress-theme/?ref=2&campaign=bazaar-panel' ); ?>" title="<?php esc_attr_e('Upgrade to Bazaar Pro','bazaar-lite');?>" target="_blank"><?php esc_html_e('Upgrade to Bazaar Pro','bazaar-lite');?></a></li>
