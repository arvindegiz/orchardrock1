		...
		?>
            ...
            <div class="notice notice-warning is-dismissible">
            	...
            	<p>
					...
					<a target="_blank" href="<?php echo esc_url( 'https://www.themeinprogress.com/bazaar-free-ecommerce-wordpress-theme/?ref=2&campaign=bazaar-notice' ); ?>" class="button button-primary"><?php esc_html_e( 'Upgrade to Bazaar Pro', 'bazaar-lite' ); ?></a>
